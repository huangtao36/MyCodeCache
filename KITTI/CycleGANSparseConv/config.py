...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--sparse_per', default='0.1', type=str)
        ...
        self.parser.add_argument('--variable_value', default='0.1', type=str)

        self.parser.add_argument('--gpu_ids', type=str, default='0')

        self.parser.add_argument('--result_root_dir', default='Sparse_compare_result')
