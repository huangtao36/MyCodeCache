...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--n_sample', default='1', type=str)

        self.parser.add_argument('--width', default='608', type=int)
        self.parser.add_argument('--height', default='176', type=int)

        self.parser.add_argument('--variable', default='dataset169')
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--display_num', type=int, default=56)
